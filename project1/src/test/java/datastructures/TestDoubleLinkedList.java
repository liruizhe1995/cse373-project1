...
public class TestDoubleLinkedList extends BaseTest {
    ...
    // in progress (Maybe completed?)
    @Test(timeout=SECOND)
    public void testDeleteBasic() {
        IList<String> list1 = this.makeBasicList();
        IList<String> list2 = this.makeBasicList();

        // delete from the end
        list1.delete(2);
        this.assertListMatches(new String[] {"a", "b"}, list1);
        ...
        list2.delete(1);
        this.assertListMatches(new String[] {"a", "c"}, list2);
        
        // delete from the front
        list2.delete(0);
        this.assertListMatches(new String[] {"c"}, list2);
    }
